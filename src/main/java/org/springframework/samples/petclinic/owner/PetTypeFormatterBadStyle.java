...
@Component public class PetTypeFormatterBadStyle implements Formatter<PetType> {private final PetRepository pets;
@Autowired public PetTypeFormatterBadStyle(PetRepository pets) {this.pets=pets;}
